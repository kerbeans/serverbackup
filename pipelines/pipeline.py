...
from transformers import CLIPFeatureExtractor, CLIPTextModel, CLIPTokenizer, CLIPVisionModel,CLIPImageProcessor
...
from module.ControlNet import ControlNetModel, ControlNetOutput
...
class FashionImg2ImgPipeline(DiffusionPipeline):
    def __init__(
        ...
        #self.register_to_config(requires_safety_checker=requires_safety_checker) modified 
