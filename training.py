...
from utils.utils import parse_args,get_full_repo_name,freeze_params,unfreeze_params,model_log      
...
def main():
    ...
    for epoch in range(args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate([unet,text_encoder,visionModel]):
